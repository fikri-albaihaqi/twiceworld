    ...
    <main className="">
      ...
      <section className="flex flex-col md:flex-row items-center xl:h-screen mx-16">
        <div className="relative w-[100vw] h-[300px] md:w-[45vw] md:h-[40vh] lg:h-[50vh] xl:h-[70vh] flex justify-center">
          <Image
            src="/twice-group-1.webp"
            alt="Twice Group Photo From 'I Got You' Set"
            fill={true}
        ...
        <div className="w-[90vw] md:w-[50vw] pl-8">
          <div className="mt-8 md:mt-0 mb-4">
            <h1
              className={`text-4xl text-cream absolute ml-1 -mt-1 ${bungee.className}`}
            >
              ABOUT TWICE
            </h1>
          ...
          <p className="mt-4 mb-4">
            TWICE is a K-Pop girl group produced by JYP Entertainment through
            the reality program [SIXTEEN]. The group is composed of 9 members:
            NAYEON, JEONGYEON, MOMO, SANA, JIHYO, MINA, DAHYUN, CHAEYOUNG, and
            TZUYU. Debuted on October 20th, 2015 with the 1st EP [THE STORY
            BEGINS] that featured the title track “Like OOH-AHH”.
          </p>
          <Link
            href="/history"
      ...
      <section className="relative flex flex-col justify-center items-center min-h-screen mt-32">
        <div className="flex w-full justify-center items-center">
          <Image
            src="/title-bg.svg"
            alt="Background for Title Text"
            width={0}
            height={0}
            className="absolute w-[280px] md:w-[360px]"
          />
          <h1
            className={`absolute text-2xl md:text-4xl text-alternate-black text-center ${bungee.className}`}
          >
            THE MEMBERS
          </h1>
          <h1
            className={`absolute text-2xl md:text-4xl text-cream -mr-3 -mt-1 text-center ${bungee.className}`}
          >
            THE MEMBERS
          </h1>
        </div>
        <Image
          src="/red-string-xl.svg"
          alt="The red string of fate connecting all twice member"
          width={1200}
          height={0}
      ...
      <section className="relative w-full flex flex-col justify-between items-center pt-32 pb-16 mb-32">
        <div className="flex justify-center mb-4">
          <h1
            className={`text-4xl text-cream absolute ml-2 -mt-1 ${bungee.className}`}
          >
            DISCOGRAPHY
          </h1>
          <h1 className={`text-4xl text-alternate-black ${bungee.className}`}>

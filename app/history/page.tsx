...
export default function Page() {
  ...
  return(
    <main className="flex flex-col">
      <section className="w-full flex flex-col justify-center items-center mt-56 mb-32">
        <div className="flex justify-center mb-4">
          <h1 className={`text-6xl text-primary-orange absolute -mr-3 -mt-1 text-center ${bungee.className}`}>
            HISTORY
          </h1>
          <h1 className={`text-6xl text-alternate-black text-center ${bungee.className}`}>
            HISTORY
          </h1>
        </div>
      </section>
